...
Revised:
    2020/04/01
        1. Add '.gif' to Read_File and Write_File.
        2. Change to lowercase before checking file extension in Read_File and
           Write_File.
        3. Return response, data in Read_URL for more processing
    2020/04/02
        1. Add list for kind of files
        2. Add '.py' to text_file
        3. Add All and Any function
"""
import json
import zlib
import brotli
